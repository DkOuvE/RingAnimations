...
// LCD selection
  ...
  // The MINIPanel display
	...
	#ifdef MKS_MINI_12864_SW_SPI
		U8GLIB_MINI12864 u8g(DOGLCD_SCK,DOGLCD_MOSI,DOGLCD_CS, DOGLCD_A0,U8G_PIN_NONE);
	#else
		U8GLIB_MINI12864 u8g(DOGLCD_CS, DOGLCD_A0); // 4 stripes
	#endif
